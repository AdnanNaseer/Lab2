package com.example.adnan_lab2;
...
public class GreetPersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sergeButton = new Button(this);
        sergeButton.setText("SVERIGE");
        horizontalLinearLayout.addView(sergeButton);
        ...
        sergeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String userInput = editText.getText().toString();
